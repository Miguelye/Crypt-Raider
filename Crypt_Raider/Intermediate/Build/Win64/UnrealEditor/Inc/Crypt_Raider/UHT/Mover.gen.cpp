...
#include "Crypt_Raider/Mover.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMover() {}
// Cross Module References
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector();
	CRYPT_RAIDER_API UClass* Z_Construct_UClass_UMover();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMover_Statics::NewProp_MoveTime_MetaData[] = {
		...
		{ "Comment", "//The amount of unit the actor should move\n" },
#endif
		{ "ModuleRelativePath", "Mover.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "The amount of unit the actor should move" },
#endif
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMover_Statics::NewProp_ShouldMove_MetaData[] = {
		{ "Category", "Mover" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//the time it takes for the actor to reach its destination\n" },
#endif
		{ "ModuleRelativePath", "Mover.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "the time it takes for the actor to reach its destination" },
#endif
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMover_Statics::NewProp_ShouldMove = { "ShouldMove", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMover), &Z_Construct_UClass_UMover_Statics::NewProp_ShouldMove_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMover_Statics::NewProp_ShouldMove_MetaData), Z_Construct_UClass_UMover_Statics::NewProp_ShouldMove_MetaData) };
	...
	template<> CRYPT_RAIDER_API UClass* StaticClass<UMover>()
	{
		return UMover::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMover);
	UMover::~UMover() {}
	struct Z_CompiledInDeferFile_FID_Crypt_Raider_Source_Crypt_Raider_Mover_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Crypt_Raider_Source_Crypt_Raider_Mover_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMover, UMover::StaticClass, TEXT("UMover"), &Z_Registration_Info_UClass_UMover, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMover), 1719784078U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Crypt_Raider_Source_Crypt_Raider_Mover_h_696033063(TEXT("/Script/Crypt_Raider"),
		Z_CompiledInDeferFile_FID_Crypt_Raider_Source_Crypt_Raider_Mover_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Crypt_Raider_Source_Crypt_Raider_Mover_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
